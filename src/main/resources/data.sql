...
-- 1. users
INSERT INTO users (id, email, password, nickname, phone_no, birthday, role, refresh_token, is_deleted, deleted_at, updated_at, created_at) VALUES
(1, 'author1@test.com', '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '김도윤', '010-1111-0001', '1990-03-15', 'AUTHOR', NULL, FALSE, NULL, NULL, '2025-01-01 09:00:00'),
(2, 'author2@test.com', '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '이서연', '010-1111-0002', '1992-07-22', 'AUTHOR', NULL, FALSE, NULL, NULL, '2025-01-01 10:00:00'),
(3, 'reader1@test.com', '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '박지훈', '010-1111-0003', '1995-11-08', 'READER', NULL, FALSE, NULL, NULL, '2025-01-02 09:00:00'),
(4, 'reader2@test.com', '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '최수아', '010-1111-0004', '1998-04-30', 'READER', NULL, FALSE, NULL, NULL, '2025-01-03 09:00:00'),
(5, 'mentor@test.com',  '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '정민준', '010-1111-0005', '1985-09-12', 'AUTHOR', NULL, FALSE, NULL, NULL, '2025-01-01 11:00:00'),
(6, 'mentee@test.com',  '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '한예린', '010-1111-0006', '2000-01-25', 'AUTHOR', NULL, FALSE, NULL, NULL, '2025-01-04 09:00:00'),
(7, 'admin@test.com',   '$2a$10$j0lHqS.XzKnx0TrsRsosm.oP3rrvBkUe/z643kJr.cUT4MJu5fMLW', '관리자',   '010-1111-0007', NULL,         'ADMIN',  NULL, FALSE, NULL, NULL, '2025-01-01 08:00:00');
...
(1, 3, 'NEW_EPISODE', '달빛 아래서 3화 업로드',    '김도윤 작가의 [달빛 아래서] 3화가 업로드되었습니다.', '/novels/1/episodes/3', FALSE, '2025-01-26 09:05:00'),
(2, 3, 'PAYMENT',     '포인트 충전 완료',            '10,000 포인트가 정상적으로 충전되었습니다.',           '/my/points',           TRUE,  '2025-03-15 10:02:00'),
(3, 1, 'FOLLOW',      '새로운 팔로워',               '박지훈 님이 회원님을 팔로우했습니다.',                 '/my/followers',        TRUE,  '2025-01-05 10:05:00'),
(4, 6, 'MENTORSHIP',  '멘토링 수락 완료',            '정민준 멘토님이 멘토링 신청을 수락했습니다.',          '/mentoring',           TRUE,  '2025-01-12 09:01:00'),
(5, 5, 'MENTORSHIP',  '새로운 멘토링 신청',          '한예린 님이 멘토링을 신청했습니다.',                    '/mentoring',           TRUE,  '2025-01-10 09:05:00');
